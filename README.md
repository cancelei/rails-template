...
bin/rails app:db_stats                             # Print (to STDOUT) count of records in DB for each ActiveRecord model
bin/rails app:template                             # Apply the template supplied by LOCATION=(/path/to/template) or URL
